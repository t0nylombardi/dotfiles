...
const sorbetLanguageClient_1 = require("./sorbetLanguageClient");
...
class SorbetStatusProvider {
    ...
    get serverStatus() {
        var _a;
        return (((_a = this.activeLanguageClient) === null || _a === void 0 ? void 0 : _a.status) ||
            (this.isStarting ? 1 /* ServerStatus.RESTARTING */ : 0 /* ServerStatus.DISABLED */));
    }
    /**
     * Start Sorbet.
     */
    startSorbet() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Create client
            const newClient = new sorbetLanguageClient_1.SorbetLanguageClient(this.context, (reason) => this.restartSorbet(reason));
